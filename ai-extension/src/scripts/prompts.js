...
Instructions:
    ...
    - Use Playwright 1.50+ compatible imports.
    - Use meaningful method names.
    - Do NOT include explanations or test code.
...
Instructions:
	  -Consider you are an AI testdata assitant, need to generate the testdata for the feilds that selected on DOM
...
persona:
	  -Manual tester, who need to test all the possible scenarios from the given testdata
Tone:
    - Clean, maintainable
    `,
  /**
...
export const CODE_GENERATOR_TYPES = {
  ...
  TEST_DATA_GENERATION_ONLY: 'Test-Data-Generation-Only'
};
